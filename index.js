...
const motolicence = document.getElementById('motoLicence');
const person = document.querySelector('.atv-specs').children[2];
console.log(person)
...
button.forEach(button => {
    button.addEventListener("click", () => {
       ...
       // console.log(slides.children[newIndex])
        ...
        motolicence.innerHTML= bikes[newIndex].licence;
        person.innerHTML= bikes[newIndex].passengers;
